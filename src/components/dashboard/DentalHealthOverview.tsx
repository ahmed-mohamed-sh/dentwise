import { getUserAppointmentsStates } from "@/lib/actions/appointments";
...
async function DentalHealthOverview() {
  ...
  const appointmentStates = await getUserAppointmentsStates(user?.id || "");
  return (
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {appointmentStates.completedAppointments}
            </div>
          ...
          <div className="text-center p-4 bg-muted/30 rounded-xl">
            <div className="text-2xl font-bold text-primary mb-1">
              {appointmentStates.totalAppointments}
            </div>
            <div className="text-sm text-muted-foreground">
              Total Appointments
            </div>
