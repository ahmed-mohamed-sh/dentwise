...
function HowItWorks() {
    return <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto">
        {/* Header */}
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed"> Our streamlined process makes dental care accessible, convenient, and stress-free for
          everyone</p>
        </div>
